...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xlink="http://www.w3.org/1999/xlink"
   ...
   <!-- Linking elmenets -->
    ...
    <!-- 
        Custom override templates to hide internal ArchivesSpace URIs from PDF output
        These empty templates suppress the display of unitid elements with type='aspace_uri'
    -->
    
    <!-- Hide the internal ASpace URL in Collection Inventory (Title/Description column) -->
    <xsl:template match="ead:unitid[@type='aspace_uri']" mode="dsc"/>
    
    <!-- Hide the internal ASpace URI in Summary Information section -->
    <xsl:template match="ead:unitid[@type='aspace_uri']" mode="overview"/>
